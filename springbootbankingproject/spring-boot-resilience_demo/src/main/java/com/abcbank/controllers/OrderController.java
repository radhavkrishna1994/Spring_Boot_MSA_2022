...
public class OrderController {
	...
	private String providerUrl = "http://localhost:8082/bookstore/getbookupdated/isbn/{isbn}";
	...
	@CircuitBreaker(name = "cb" ,fallbackMethod = "defaultFallback")
	...
	public OrderedBook defaultFallback(Throwable t)
	{
